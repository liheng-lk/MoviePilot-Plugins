...
固定接管 MoviePilot 订阅，按观影迅雷秒传、光鸭直接转存、Magnet、ED2K 的顺序补充媒体库。v1.12.23 修复观影零结果误展开推荐内容、“我的资源检索”把来源健康误报为影片有资源、无关候选泄漏、跨订阅缓存污染及重复详情请求；搜索日志现在明确区分待核验链接、精确候选、真实入队和最终落盘，部分来源失败会显示为检索未完成。
