...
固定接管 MoviePilot 订阅，按观影迅雷秒传、光鸭直接转存、Magnet、ED2K 的顺序补充媒体库。当前 2.0.13 为 Controlled Real-World Beta；开发采用 Authority-first 结构，并提供独立 ARCHITECTURE / DEVELOPMENT / CHANGELOG 文档与维护性 CI 门禁，便于 Fork、二开与审查。
