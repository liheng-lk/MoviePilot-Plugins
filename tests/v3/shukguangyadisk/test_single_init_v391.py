...
class SingleInitV393ContractTest(unittest.TestCase):
    ...
    def test_release_metadata_and_federation_cache_are_consistent(self):
        ...
        self.assertEqual(local["version"], "3.9.3")
        self.assertEqual(package["version"], "3.9.3")
        self.assertIn("v3.9.3", local["history"])
        self.assertIn("?v=3.9.3", remote)
