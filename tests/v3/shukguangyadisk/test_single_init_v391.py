...
class SingleInitV3100ContractTest(unittest.TestCase):
    ...
    def test_release_metadata_and_federation_cache_are_consistent(self):
        ...
        self.assertEqual(local["version"], "3.10.0")
        self.assertEqual(package["version"], "3.10.0")
        self.assertIn("v3.10.0", local["history"])
        self.assertIn("?v=3.10.0", remote)
