...
class SingleInitV398ContractTest(unittest.TestCase):
    ...
    def test_release_metadata_and_federation_cache_are_consistent(self):
        ...
        self.assertEqual(local["version"], "3.9.8")
        self.assertEqual(package["version"], "3.9.8")
        self.assertIn("v3.9.8", local["history"])
        self.assertIn("?v=3.9.8", remote)
