...
def test_dailyassistant_exposes_only_final_loader_candidate():
    final_pos = ENTRY.index("class DailyAssistant(DailyAssistantCalendarV120Mixin, DailyAssistantV110Mixin, DailyAssistantV100):")
    ...
    assert "plugin_version = \"1.2.0\"" in ENTRY[final_pos:export_pos]
