...
class DailyNewDramaV13Tests(unittest.TestCase):
    def test_v13_metadata_is_consistent(self):
        self.assertIn('plugin_version = "1.3.5"', SOURCE)
        ...
        self.assertEqual(local["version"], "1.3.5")
        self.assertEqual(package["version"], "1.3.5")
        self.assertEqual(index["version"], "1.3.5")
