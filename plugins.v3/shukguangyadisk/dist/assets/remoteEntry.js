// v3.9.11 single-init runtime; v390 page chunk remains the current UI implementation.
const legacyPageCompat = './__federation_expose_AssistantPage-v352.js?v=3.9.11';

const moduleMap = {
  './Page': () => import('./__federation_expose_AssistantPage-v390.js?v=3.9.11').then((mod) => () => mod.default),
