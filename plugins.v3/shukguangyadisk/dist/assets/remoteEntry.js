// v3.9.2 single-init runtime; v390 page chunk remains the current UI implementation.
const legacyPageCompat = './__federation_expose_AssistantPage-v352.js?v=3.9.4';

const moduleMap = {
  './Page': () => import('./__federation_expose_AssistantPage-v390.js?v=3.9.4').then((mod) => () => mod.default),
