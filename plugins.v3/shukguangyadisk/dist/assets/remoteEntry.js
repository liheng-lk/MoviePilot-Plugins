// v3.9.14 single-init runtime; v390 page chunk remains the current UI implementation.
const legacyPageCompat = './__federation_expose_AssistantPage-v352.js?v=3.9.14';

const moduleMap = {
  './Page': () => import('./__federation_expose_AssistantPage-v390.js?v=3.9.14').then((mod) => () => mod.default),
