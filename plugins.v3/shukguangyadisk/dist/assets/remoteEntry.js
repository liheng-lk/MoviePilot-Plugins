...
const legacyPageCompat = './__federation_expose_AssistantPage-v352.js?v=3.9.2';

const moduleMap = {
  './Page': () => import('./__federation_expose_AssistantPage-v390.js?v=3.9.2').then((mod) => () => mod.default),
