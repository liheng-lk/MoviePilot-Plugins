...
export default defineComponent({
  ...
  setup(props,{emit}){
    ...
    return()=>h('div',{class:'gy-assistant'},[h('style',css),h('div',{class:'gy-shell'},[
      h('header',{class:'gy-header'},[h('div',{class:'gy-brand'},[h('div',{class:'gy-logo'},'☁'),h('div',[h('div',{class:'gy-title'},'光鸭云盘助手'),h('div',{class:'gy-sub'},'MoviePilot 光鸭云盘存储插件')])]),h('div',{class:'gy-actions'},[h('button',{class:'gy-iconbtn',title:'刷新状态',onClick:refresh},refreshing.value?'◔':'↻'),h('button',{class:'gy-iconbtn',title:'设置',onClick:()=>emit('switch')},'⚙'),h('button',{class:'gy-iconbtn',title:'关闭',onClick:()=>emit('close')},'×')])]),
