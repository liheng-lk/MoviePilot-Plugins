...
export default defineComponent({
  name: 'GuangyaCloudAssistantV310',
  ...
  setup(props,{emit}) {
    ...
    const previewTable=()=>!plan.value?null:h('div',{class:'gyo-card'},[
      h('div',{class:'gyo-card-title'},'整理预览'),h('div',{class:'gyo-card-sub'},plan.value.safe_note||'先预览、后确认执行'),
    ...
    const organizer=()=>h('div',{class:'gyo-shell'},[
      h('div',{class:'gyo-head'},[h('div',[h('div',{class:'gyo-title'},'网盘整理'),h('div',{class:'gyo-sub'},'MoviePilot 负责识别与目录分类策略，光鸭负责同盘移动/复制；执行前必须预览')]),h('span',{class:'gyo-badge'},'v3.1.0')]),
