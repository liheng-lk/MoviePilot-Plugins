...
v1.10.15 将迅雷分享处理严格对齐已验证的 v1.1.3 脚本：生成原始 sumuve JSON 合同，完整透传 shareId/passCodeToken，补齐 files、download 与 share/save/task 回查兜底，并排除缩略图 CDN 误算 CID。
