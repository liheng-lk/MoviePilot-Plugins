...
class GuangYaTransferAssistant(
    ...
    """固定分流 + 完整观影会话 + 人工验证码 + 迅雷秒传 + ResourceGroup + 光鸭原生云添加运行时。"""
